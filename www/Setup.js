...
var SetupState = {
    ...
    {		
        ...
        game.load.bitmapFont('mecha', 'Assets/Font/mecha.png', 'Assets/Font/mecha.fnt');

        game.load.image('soundOn', 'Assets/soundButton/soundOnWhite.png');
        game.load.image('soundOff', 'Assets/soundButton/soundOffWhite.png');


        game.load.audio('click1', 'Assets/sfx/click/Click_Electronic_01.ogg');
        game.load.audio('click2', 'Assets/sfx/click/Click_Electronic_02.ogg');
        game.load.audio('click3', 'Assets/sfx/click/Click_Electronic_03.ogg');
        game.load.audio('click4', 'Assets/sfx/click/Click_Electronic_05.ogg');

        game.load.image('gear', 'Assets/Icons/gear.png');
